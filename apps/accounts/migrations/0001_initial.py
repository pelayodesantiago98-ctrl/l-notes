    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Usuario'), ('admin', 'Admin')], default='user', max_length=16)),
                ('theme', models.CharField(choices=[('dark', 'Oscuro'), ('light', 'Claro'), ('dracula', 'Drácula'), ('pink', 'Rosa'), ('aqua', 'Aqua')], default='dark', max_length=16)),
